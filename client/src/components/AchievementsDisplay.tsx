  ...
  const achievements: Achievement[] = [
    {
      ...
      category: "test",
      requiredPoints: 0,
      unlocked: userBadges.some((b: any) => b.badgeId === 1) || true,
    },
    {
      id: "intermediate",
      name: "المتمكن",
      ...
      category: "test",
      requiredPoints: 100,
      unlocked: userBadges.some((b: any) => b.badgeId === 4) || user?.points >= 100,
    },
    {
      id: "advanced",
      name: "المتقدم",
      ...
      category: "test",
      requiredPoints: 250,
      unlocked: userBadges.some((b: any) => b.badgeId === 4) || user?.points >= 250,
    },
    {
      id: "master",
      name: "الخبير",
      ...
      category: "test",
      requiredPoints: 500,
      unlocked: userBadges.some((b: any) => b.badgeId === 4) || user?.points >= 500,
    },
    {
      id: "champion",
      name: "البطل",
      ...
      category: "level",
      requiredPoints: 1000,
      unlocked: userBadges.some((b: any) => b.badgeId === 3) || user?.points >= 1000,
    },
    {
      id: "scholar",
      name: "العالم",
      ...
      category: "test",
      requiredPoints: 1500,
      unlocked: userBadges.some((b: any) => b.badgeId === 2) || user?.points >= 1500,
    },
    {
      id: "collector",
      name: "الجامع",
    ...
    },
    {
      ...
      category: "streak",
      requiredPoints: 200,
      unlocked: userBadges.some((b: any) => b.badgeId === 5) || user?.points >= 200,
    },
    {
      id: "genius",
      name: "العبقري",
