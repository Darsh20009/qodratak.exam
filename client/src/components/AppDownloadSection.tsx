...
const AppDownloadSection: React.FC = () => {
  ...
  const InstructionStep = ({ number, title, description, icon }: {
    ...
    <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-teal-500 rounded-lg border border-blue-100">
  ...
  const DesktopInstructions = () => (
    <div className="space-y-4">
      <div className="text-center mb-6">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-green-100 rounded-full mb-4">
          <Monitor className="h-8 w-8 text-green-700" />
        </div>
  ...
  return (
    <div className="w-full" dir="rtl">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-500 to-emerald-600 rounded-2xl mb-4 shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <Card className="relative overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group"
          ...
          <CardContent className="text-center">
            <Button className="w-full bg-green-100 hover:bg-green-100 text-white mb-3">
              <Download className="h-4 w-4 mr-2" />
              تعليمات التثبيت
            </Button>
            <div className="flex justify-center gap-2">
      ...
      <div className="text-center mb-8">
        <Button 
          ...
          size="lg"
          className="bg-gradient-to-r from-blue-500 to-emerald-600 hover:from-blue-600 hover:to-emerald-600 text-white px-8 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
        >
      ...
      {/* مميزات التطبيق */}
      <div className="bg-gradient-to-r from-blue-50 to-emerald-600 rounded-2xl p-8 text-[#2b3245]">
