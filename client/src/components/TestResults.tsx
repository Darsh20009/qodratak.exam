  ...
  return (
    <div className="p-6 overflow-y-auto custom-scrollbar">
      ...
      {(categoryPerformance.verbalTotal > 0 || categoryPerformance.quantitativeTotal > 0) && (
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl p-6 mb-6 border border-blue-200/50 dark:border-blue-700/50">
