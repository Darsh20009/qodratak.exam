...
function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "الاختبارات التأهيلية", href: "/qualification", icon: GraduationCapIcon },
...
```
App.tsx has been modified to remove the qualification exam route.
```import React from 'react';
import { Switch, Route, Link, useLocation } from "wouter";
import { queryClient } from "./lib/queryClient";
import { QueryClientProvider } from "@tanstack/react-query";
...
```
App.tsx has been modified to remove the qualification exam route.import React from 'react';
import { Switch, Route, Link, useLocation } from "wouter";
import { queryClient } from "./lib/queryClient";
import { QueryClientProvider } from "@tanstack/react-query";
import { Toaster } from "@/components/ui/toaster";
