...
export function FreeQuantitativeTestRunner() {
  ...
  // Fetch questions for free quantitative test (available without login)
  const { data: questions = [], isLoading, error } = useQuery<Question[]>({
    queryKey: ['/api/questions/free-test/quantitative'],
  });
  ...
  const finishTest = async () => {
    ...
    const testResult = {
      testId: 'free-quantitative-test',
      testName: 'الاختبار الكمي المجاني',
      ...
      examType: 'اختبار كمي مجاني'
    };

    const existingResults = JSON.parse(localStorage.getItem('quantitativeTestResults') || '[]');
    existingResults.push(testResult);
    localStorage.setItem('quantitativeTestResults', JSON.stringify(existingResults));
      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-amber-600 dark:from-gray-900 dark:to-red-900 flex items-center justify-center">
        <Card className="max-w-md mx-4">
          <CardContent className="p-6 text-center">
            ...
            <Button onClick={() => setLocation('/quantitative-tests')} className="w-full">
              العودة إلى اختبارات الكمي
            </Button>
          </CardContent>
        </Card>
      </div>
  ...
  if (showResults) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 dark:from-gray-900 dark:to-blue-900 p-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex gap-4 justify-center">
            <Button onClick={() => setLocation('/quantitative-tests')} className="flex items-center gap-2">
  ...
  if (!isRunning && !showResults) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-100 dark:from-gray-900 dark:to-blue-900 flex items-center justify-center p-4">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          ...
          <Card className="border-2 border-blue-200 dark:border-blue-700">
            <CardHeader className="text-center">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <CardTitle className="text-3xl text-blue-800 dark:text-blue-200">
                  الاختبار الكمي المجاني
                </CardTitle>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  ...
                  <div>
                    <p className="font-semibold text-blue-800 dark:text-blue-200">عدد الأسئلة</p>
                    <p className="text-blue-600 dark:text-blue-300">20 سؤال متنوع</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  <Clock className="w-6 h-6 text-blue-600" />
                  <div>
                    <p className="font-semibold text-blue-800 dark:text-blue-200">الوقت المحدد</p>
                    <p className="text-blue-600 dark:text-blue-300">20 دقيقة</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg p-4">
                ...
                <ul className="text-yellow-700 dark:text-yellow-300 space-y-1 text-sm">
                  ...
                  <li>• الاختبار يحتوي على أسئلة متنوعة من جميع أقسام الكمي</li>
              ...
              <div className="flex gap-4">
                <Button onClick={startTest} className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3">
                  <Play className="w-4 h-4 mr-2" />
                  بدء الاختبار
                </Button>
                <Button onClick={() => setLocation('/quantitative-tests')} variant="outline" className="flex-1 py-3">
