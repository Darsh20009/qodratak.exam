            ...
            <CardHeader className="text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <motion.div
                  ...
                  className="bg-gradient-to-br from-blue-50 to-emerald-600 dark:from-blue-900/20 dark:to-emerald-600/20 p-6 rounded-2xl"
                >
          ...
          <CardHeader>
            <CardTitle className="flex flex-wrap items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <div className={`w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-gradient-to-r ${modeInfo.color} text-white flex items-center justify-center flex-shrink-0`}>
                  {modeInfo.icon}
                </div>
                <div className="min-w-0">
                  <div className="text-lg md:text-2xl font-bold">{modeInfo.title}</div>
              ...
              {challengeData.mode === 'timed' && (
                <div className="text-right flex-shrink-0">
                  <div className={`text-2xl md:text-3xl font-mono font-bold ${getTimeColor()}`}>
          ...
          <div className="flex items-center gap-1.5">
            {challengeData.mode === 'timed' && (
              ...
              >
                ...
                <span className="hidden sm:inline">{isPaused ? 'استكمال' : 'إيقاف مؤقت'}</span>
              </Button>
            )}
