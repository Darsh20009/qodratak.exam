...
const verbalSubcategories = [
  { id: 'التناظر اللفظي', name: 'التناظر اللفظي', icon: '🔗', color: 'from-blue-500 to-purple-600' },
  { id: 'إكمال الجمل', name: 'إكمال الجمل', icon: '✍️', color: 'from-green-500 to-blue-500' },
  { id: 'استيعاب المقروء', name: 'استيعاب المقروء', icon: '📖', color: 'from-purple-500 to-pink-500' },
...
const quantitativeSubcategories = [
  { id: 'الهندسة', name: 'الهندسة', icon: '📐', color: 'from-indigo-500 to-purple-600' },
  { id: 'عمليات حسابية', name: 'عمليات حسابية', icon: '🧮', color: 'from-blue-500 to-indigo-500' },
  ...
  { id: 'الحركة والأنماط', name: 'الحركة والأنماط', icon: '🔄', color: 'from-pink-500 to-red-500' },
  { id: 'النسبة والتناسب', name: 'النسبة والتناسب', icon: '📏', color: 'from-cyan-500 to-blue-500' },
  { id: 'الإحصاء', name: 'الإحصاء', icon: '📈', color: 'from-purple-500 to-indigo-500' },
  { id: 'المعادلات', name: 'المعادلات', icon: '🔢', color: 'from-emerald-500 to-green-500' },
  { id: 'أفكار متنوعة', name: 'أفكار متنوعة', icon: '🧩', color: 'from-rose-500 to-pink-500' }
];
...
export function LevelAssessmentPage() {
  ...
  const getLevelIcon = (level: string) => {
    switch (level) {
      ...
      case 'متقدم': return <Diamond className="h-6 w-6 text-purple-500" />;
  ...
  const getLevelColor = (level: string) => {
    switch (level) {
      ...
      case 'متقدم': return 'from-purple-400 to-pink-500';
      case 'متوسط': return 'from-blue-400 to-indigo-500';
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 p-6">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            >
              <Card className="text-center bg-gradient-to-br from-purple-50 to-pink-100 dark:from-purple-900/20 dark:to-pink-900/20">
                <CardContent className="p-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-slate-900 dark:via-blue-900 dark:to-indigo-900 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Card className="max-w-4xl mx-auto bg-gradient-to-r from-blue-500 to-purple-600 text-white border-0">
