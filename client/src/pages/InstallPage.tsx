...
const InstallPage: React.FC = () => {
  ...
  const InstructionStep = ({ number, title, description, icon }: {
    ...
    <div className="flex items-start gap-4 p-6 bg-gradient-to-r from-blue-50 to-teal-500 rounded-xl border border-blue-100 hover:shadow-lg transition-all duration-300">
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full mb-6 shadow-lg">
          <Monitor className="h-10 w-10 text-green-700" />
        </div>
      ...
      <div className="text-center mt-8">
        <Button 
          onClick={installPWA}
          size="lg"
          className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-600 hover:to-emerald-600 text-white px-8 py-4 text-lg font-bold shadow-xl hover:shadow-2xl transition-all duration-300"
        >
          <Download className="h-6 w-6 mr-3" />
          تثبيت التطبيق الآن
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl" dir="rtl">
      ...
      <div className="text-center mb-12">
        ...
        <div className="inline-flex items-center justify-center mb-6">
          <div className="relative">
            <div className="w-32 h-32 bg-gradient-to-r from-blue-600 to-emerald-600 rounded-2xl flex items-center justify-center shadow-2xl">
              <img src={newLogoPath} alt="شعار قدراتك" className="h-20 w-20 object-contain rounded-xl" />
            </div>
            <div className="absolute -inset-4 bg-gradient-to-r from-blue-400 to-emerald-600 rounded-2xl blur-xl opacity-30 -z-10"></div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        ...
        <Card className="relative overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer group border-2 border-green-200 hover:border-green-400" 
          ...
          <CardContent className="text-center relative z-10">
            ...
            <div className="flex justify-center gap-2 mb-4">
              ...
              <Badge className="bg-green-100 text-green-700 border border-green-400">آمن</Badge>
            </div>
        ...
        <Card className="relative overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer group border-2 border-blue-200 hover:border-blue-400"
          ...
          <CardContent className="text-center relative z-10">
            ...
            <div className="flex justify-center gap-2 mb-4">
              ...
              <Badge className="bg-green-100 text-green-700 border border-green-400">iOS 12+</Badge>
            </div>
        ...
        {/* سطح المكتب */}
        <Card className="relative overflow-hidden hover:shadow-2xl transition-all duration-500 cursor-pointer group border-2 border-green-400 hover:border-green-400"
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-green-600/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          <div className="relative">
            ...
            <CardTitle className="text-2xl mb-3 group-hover:text-green-700 transition-colors">سطح المكتب</CardTitle>
            <p className="text-gray-600">Windows, Mac, Linux</p>
          </CardHeader>

          <CardContent className="text-center relative z-10">
            <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-600 hover:to-emerald-600 text-white mb-4 py-3 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
              <Download className="h-5 w-5 mr-2" />
              تثبيت التطبيق
            </Button>
            <div className="flex justify-center gap-2 mb-4">
              <Badge className="bg-green-100 text-green-700 border border-green-400">Chrome</Badge>
      ...
      <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-3xl p-10 shadow-xl">
        <h3 className="text-3xl font-bold text-center mb-8 bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="text-center group">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
