  ...
  const verbalTests: VerbalTest[] = [
    {
      ...
      description: 'القسم الأول من نظام الـ 5 أقسام - 13 سؤال في 13 دقيقة مع تحليل تفصيلي',
      questionCount: 13,
      timeLimit: 13,
      difficulty: 'متوسط',
    ...
    },
    {
      ...
      description: 'القسم الثاني من نظام الـ 5 أقسام - 13 سؤال في 13 دقيقة مع تحليل تفصيلي',
      questionCount: 13,
      timeLimit: 13,
      difficulty: 'سهل',
    ...
    },
    {
      ...
      description: 'القسم الثالث من نظام الـ 5 أقسام - 13 سؤال في 13 دقيقة مع تحليل تفصيلي',
      questionCount: 13,
      timeLimit: 13,
      difficulty: 'صعب',
    ...
    },
    {
      ...
      description: 'القسم الرابع من نظام الـ 5 أقسام - 13 سؤال في 13 دقيقة مع تحليل تفصيلي',
      questionCount: 13,
      timeLimit: 13,
      difficulty: 'صعب',
    ...
    {
      id: 'vocabulary-test',
      name: 'اختبار المفردات والمعاني',
      subcategory: 'المفردات والمعاني',
      description: 'القسم الخامس من نظام الـ 5 أقسام - 13 سؤال في 13 دقيقة مع تحليل تفصيلي',
      questionCount: 13,
      timeLimit: 13,
      difficulty: 'متوسط',
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
            {([
              { value: "13", label: "سؤال لكل قسم", icon: Target },
              { value: "5", label: "أقسام متخصصة", icon: Trophy },
