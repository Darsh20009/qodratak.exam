...
export function EnhancedQuantitativeTests() {
  ...
  const getLevelBadge = (level: number) => {
    ...
    if (level <= 4) return { icon: <Brain className="w-4 h-4" />, color: 'bg-green-600' };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-4">
            <div className="p-3 rounded-full" style={{ background: '#1a7c3e' }}>
              <Calculator className="w-8 h-8 text-white" />
            </div>
            <h1 className="text-4xl font-bold bg-gradient-to-r gray-800 dark:text-white">
              ...
              <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-green-700">{Math.floor(mathStats.totalTimeSpent / 60)}h</div>
