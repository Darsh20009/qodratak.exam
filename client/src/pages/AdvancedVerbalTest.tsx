...
export function AdvancedVerbalTest() {
  ...
  if (showResults && testResults) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:to-green-900/20 p-4">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl font-bold text-gray-800 dark:text-white mb-2">
              نتائج الاختبار المتقدم
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300">
              تحليل شامل لأدائك في الاختبار اللفظي
            </p>
          </motion.div>
          ...
          <Card className="mb-8">
            <CardHeader>
              <CardTitle className="text-2xl">نتائج الأقسام</CardTitle>
            </CardHeader>
            <CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                {Object.entries(testResults.subcategoryBreakdown).map(([subcategory, data]) => (
                  <div key={subcategory} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div>
