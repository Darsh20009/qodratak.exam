...
const faqs = [
  ...
  ["هل توجد باقة مجانية؟", "نعم، يمكنك البدء بالمحتوى والاختبار التشخيصي المجاني، وتظهر تفاصيل أي اشتراك متاح في قسم الباقات بالصفحة الرئيسية."],
];
    ...
    <div className="min-h-screen bg-[#F7F4EE] text-[#172337]" dir="rtl">
      <main className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-16">
        ...
        <section className="mt-12 rounded-3xl border border-[#C9D9E0] bg-white p-6 shadow-sm sm:p-8">
          ...
          <p className="mt-4 text-sm leading-8 text-[#5E7180]">تظهر الباقات والأسعار المتاحة في قسم الباقات بالصفحة الرئيسية، وتتم المعاملات عند تفعيل الاشتراكات عبر بوابات دفع إلكترونية آمنة تدعم مدى وApple Pay وVisa وMastercard.</p>
          <Link href="/#plans" className="mt-5 inline-flex rounded-xl bg-[#17354A] px-5 py-3 text-sm font-black text-white hover:bg-[#254d65]">عرض الباقات والاشتراكات</Link>
        </section>
