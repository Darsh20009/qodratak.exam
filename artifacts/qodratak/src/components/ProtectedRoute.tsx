...
export default function ProtectedRoute({ 
  ...
  const isPremium = subscriptionType === 'Pro' || subscriptionType === 'Pro Life' || subscriptionType === 'Pro Life Plus' || subscriptionType === 'Pro Live';
  ...
  if (requiresPremium && !isPremium && showUpgrade) {
    ...
    if (!hasUsedFreeTrial) {
      return (
        <div className="container mx-auto p-6 space-y-6">
          {/* Free Trial Offer */}
          <div className="bg-gradient-to-r from-green-600 via-blue-600 to-emerald-600 p-8 rounded-3xl text-white text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card className="border-2 border-blue-500 shadow-lg">
              <CardHeader className="text-center">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-full flex items-center justify-center mx-auto mb-2">
          ...
          <Card className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border-green-200 dark:border-green-700">
            <CardContent className="p-6 text-center">
              ...
              <p className="text-green-600 dark:text-green-300 text-sm mb-4">
                اشترك الآن للوصول لكامل محتوى المنصة
              </p>
              <Button 
    ...
    return (
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-green-600 to-amber-600 p-8 rounded-3xl text-white text-center">
        ...
        <Card className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 border-green-200 dark:border-green-700">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-green-600 dark:text-green-300 text-sm mb-4">
              اشترك الآن للحصول على وصول كامل لجميع الأسئلة والاختبارات
            </p>
            <Button 
              className="bg-green-500 hover:bg-green-600 text-white"
              onClick={() => window.location.href = '/subscription'}
