  ...
  if (!question || !currentTestType) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center p-8 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-emerald-600/10 animate-gradient-x"></div>
        ...
        <div className="text-center space-y-4 relative z-10">
          <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-emerald-600 animate-pulse">
            جاري تحميل الأسئلة
          </h3>
        ...
        <button
          ...
          className="mt-8 py-3 px-6 bg-gradient-to-r from-primary to-emerald-600 text-white rounded-full 
        ...
        <div className="absolute -top-10 -right-10 w-40 h-40 bg-green-100/20 rounded-full blur-3xl animate-pulse delay-700"></div>
      </div>
    );
  }
