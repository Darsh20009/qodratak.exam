...
export default function TestResultsPage() {
  ...
  const getWrongQuestionIds = (): number[] => {
    ...
    result.questions.forEach((question, index) => {
      const userAnswer = result.answers![index.toString()];
      const correctAnswer = question.correctOptionIndex?.toString() || question.correct_answer;
      if (userAnswer !== correctAnswer && question.id) {
...
<body>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <Button 
              ...
              style={{ borderColor: '#1a7c3e', color: '#1a7c3e' }}
            >
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 relative overflow-hidden">
      {/* خلفية هادئة */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#1a7c3e] via-[#22a85a] to-[#1a7c3e]" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-4xl">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl md:text-5xl font-bold" style={{ color: '#1a7c3e' }}>
                🎯 نتيجة الاختبار
              </h1>
          ...
          <Card className="mb-8 overflow-hidden shadow-2xl bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg border-2 border-white/30">
            ...
            <CardHeader className="text-center pb-4 relative">
              <div className="absolute top-4 right-4">
                <Badge className="text-white" style={{ background: '#1a7c3e' }}>
            ...
            <CardContent>
              ...
              <div className="mb-8">
                <div className="relative">
                  ...
                  <motion.div
                    ...
                    style={{ background: 'linear-gradient(to right, #22a85a, #1a7c3e)' }}
                    initial={{ width: 0 }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <motion.div
                  ...
                  className="bg-[#f0fdf4] dark:bg-green-900/10 p-6 rounded-2xl border border-[#bbf7d0] hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-14 h-14 rounded-xl flex items-center justify-center shadow-lg" style={{ background: '#1a7c3e' }}>
                ...
                <motion.div
                  ...
                  className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-200 hover:shadow-lg transition-all duration-300"
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-14 h-14 rounded-xl flex items-center justify-center shadow-lg bg-amber-500">
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-14 h-14 rounded-xl flex items-center justify-center shadow-lg bg-sky-600">
                      <BarChart3 className="w-7 h-7 text-white" />
                    </div>
                    <div>
                      <div className="text-sm text-gray-500">معدل الإجابة</div>
                      <div className="font-bold text-lg text-gray-800 dark:text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                >
                  <Button 
                    onClick={handleBackToRecords}
                    className="text-white px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 group"
                    style={{ background: '#1a7c3e' }}
                  >
                ...
                {result?.questions && result.questions.length > 0 && (
                  ...
                  >
                    <Button
                      onClick={() => setLocation('/exam-review')}
                      className="relative text-white px-8 py-4 text-lg shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group"
                      style={{ background: '#22a85a' }}
                    >
                ...
                >
                  <Button
                    onClick={() => setLocation('/verbal-tests')}
                    variant="outline"
                    className="border-2 px-8 py-4 text-lg transition-all duration-300 group"
                    style={{ borderColor: '#1a7c3e', color: '#1a7c3e' }}
                  >
        ...
        >
          <Card className="bg-[#f0fdf4] dark:bg-green-900/10 border-2 border-[#bbf7d0] shadow-xl">
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-2xl">
                <Brain className="w-7 h-7" style={{ color: '#1a7c3e' }} />
