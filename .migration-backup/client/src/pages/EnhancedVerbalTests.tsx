...
export function EnhancedVerbalTests() {
  ...
  const enhancedVerbalTests: EnhancedVerbalTest[] = [
    ...
    {
      id: 'odd_word_master',
      name: 'سيد المفردة الشاذة',
      subcategory: 'المفردة الشاذة المتقدمة',
      description: 'اختبار متخصص للمفردة الشاذة - تمييز الكلمة المختلفة من بين المجموعة بدقة',
      questionCount: 40,
      timeLimit: 35,
      difficulty: 'متقدم',
      level: 3,
      ...
      gradientTo: 'to-orange-100',
      specialFeatures: ['تحليل دلالي متقدم', 'نصائح لفظية ذكية', 'تقارير تفصيلية'],
  ...
  const getDifficultyColor = (difficulty: string) => {
    switch (difficulty) {
      ...
      case 'متقدم': return 'bg-green-100 text-green-800';
  ...
  const getLevelBadge = (level: number) => {
    ...
    if (level <= 4) return { icon: <Crown className="w-4 h-4" />, color: 'bg-green-600' };
    return { icon: <Diamond className="w-4 h-4" />, color: 'bg-red-500' };
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-green-50 to-emerald-50 dark:from-gray-900 dark:via-green-900 dark:to-emerald-900 p-4">
      <div className="max-w-7xl mx-auto space-y-8">
              ...
              <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                    ...
                    <div className="text-center">
                      <div className="text-3xl font-bold text-green-700">{Math.floor(userStats.totalTimeSpent / 60)}h</div>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <Card className="text-white" style={{ background: '#1a7c3e' }}>
