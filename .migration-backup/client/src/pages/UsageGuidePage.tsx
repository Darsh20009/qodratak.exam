...
export function UsageGuidePage() {
  ...
  const features = [
    ...
    },
    {
      icon: MessageSquare,
      title: "المساعد الذكي",
      description: "مساعد ذكي شخصي للإجابة على أسئلتك وتوجيهك في دراستك",
      premium: false
    },
    {
      icon: Clock,
  ...
  return (
    <div className="w-full bg-background pb-24 md:pb-8">
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-600 to-slate-900 relative overflow-hidden rounded-3xl md:mx-4 md:mb-4 overflow-hidden">
      {/* Animated Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-green-100 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse delay-1000"></div>
        <div className="absolute top-40 left-40 w-80 h-80 bg-amber-100 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse delay-2000"></div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-full blur-lg opacity-50"></div>
              <div className="relative p-4 bg-gradient-to-r from-blue-500 via-green-600 to-amber-600 rounded-full shadow-2xl">
                <Lightbulb className="h-12 w-12 text-white" />
              </div>
            </div>
          </div>
          <h1 className="text-6xl font-bold bg-gradient-to-r from-blue-400 via-green-600 to-amber-600 bg-clip-text text-transparent mb-4">
        ...
        <Tabs defaultValue="overview" className="w-full">
          <div className="flex justify-center mb-8">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-2xl blur-lg opacity-30"></div>
              <TabsList className="relative grid grid-cols-4 bg-black/30 backdrop-blur-xl border border-white/20 p-2 rounded-2xl">
                <TabsTrigger
                  value="overview"
                  className="flex items-center gap-2 px-6 py-3 text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-blue-500 data-[state=active]:to-emerald-600 data-[state=active]:text-white rounded-xl transition-all duration-300"
                >
                ...
                <TabsTrigger
                  value="features"
                  className="flex items-center gap-2 px-6 py-3 text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-green-600 data-[state=active]:to-amber-600 data-[state=active]:text-white rounded-xl transition-all duration-300"
                >
                ...
                <TabsTrigger
                  value="tutorial"
                  className="flex items-center gap-2 px-6 py-3 text-white data-[state=active]:bg-gradient-to-r data-[state=active]:from-amber-500 data-[state=active]:to-orange-500 data-[state=active]:text-white rounded-xl transition-all duration-300"
                >
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="text-center p-4 bg-green-100/20 rounded-lg">
                      <h4 className="text-2xl font-bold text-green-700">10+</h4>
              ...
              <Card className="bg-black/20 backdrop-blur-xl border border-white/20 text-white">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-green-400 mt-0.5 flex-shrink-0" />
                      <p className="text-white/80">مساعد ذكي شخصي للإرشاد والتوجيه</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-black/20 backdrop-blur-xl border border-white/20 text-white">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center text-white font-bold text-sm">2</div>
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center text-white font-bold text-sm">3</div>
                      <div>
              ...
              <Card className="bg-black/20 backdrop-blur-xl border border-white/20 text-white">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="text-center p-4 bg-green-100/20 rounded-lg">
                      <Tablet className="h-8 w-8 text-green-700 mx-auto mb-2" />
                      <h4 className="font-semibold text-sm">الأجهزة اللوحية</h4>
                      <p className="text-xs text-white/70">iPad & Android</p>
                    </div>
                    <div className="text-center p-4 bg-amber-100/20 rounded-lg">
                      <Monitor className="h-8 w-8 text-amber-700 mx-auto mb-2" />
            ...
            <Card className="bg-black/20 backdrop-blur-xl border border-white/20 text-white">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-xl font-semibold text-green-700">للمشتركين المميزين</h3>
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        <Crown className="h-5 w-5 text-green-700 mt-0.5 flex-shrink-0" />
            ...
            <Card className="bg-black/20 backdrop-blur-xl border border-white/20 text-white">
              ...
              <CardContent className="text-center space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="p-4 bg-green-100/20 rounded-lg">
                    <Heart className="h-8 w-8 text-green-700 mx-auto mb-2" />
                    <h4 className="font-semibold">الدعم المباشر</h4>
                    <p className="text-sm text-white/70">للمشتركين المميزين</p>
                  </div>
                  <div className="p-4 bg-amber-100/20 rounded-lg">
