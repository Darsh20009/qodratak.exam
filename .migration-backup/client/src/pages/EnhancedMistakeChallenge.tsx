...
export default function EnhancedMistakeChallenge() {
  ...
  if (gameMode === 'selection') {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-600 to-teal-500 p-4">
  ...
  if (gameMode === 'playing' && challengeData && selectedMode) {
    ...
    if (!currentQuestion) {
      return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-600 to-teal-500 p-4 flex items-center justify-center">
                  ...
                  <div className="flex items-center gap-2 md:gap-4">
                    {selectedMode.timeLimit && (
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="font-mono text-base md:text-lg">{formatTime(timeRemaining)}</span>
                      </div>
                    )}
                    <Button
                    ...
                    <EndTestButton 
                      onEndTest={() => setLocation('/mistake-challenges')}
                      variant="floating"
                      testName={selectedMode?.name || "تحدي الأخطاء"}
                      showProgress={true}
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {playerStats.powerUps.map((powerUp) => (
                      <Button
                        ...
                        size="sm"
                        className="bg-green-100/20 hover:bg-green-100/30 text-white border-green-400/30"
                      >
                        {powerUp.icon}
  ...
  if (gameMode === 'results') {
    ...
    const getVictoryLevel = () => {
      ...
      if (percentage >= 90) return {
        ...
        color: 'from-blue-400 via-green-600 to-teal-500',
      ...
      return {
        ...
        color: 'from-green-600 via-pink-400 to-rose-500',
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-600 to-teal-500 p-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
              <Card className="bg-green-100/10 backdrop-blur-sm border-green-400/30 text-green-700 text-center">
                <CardContent className="p-6">
                  <div className="text-4xl font-bold text-green-700 mb-2">{playerStats.score}</div>
